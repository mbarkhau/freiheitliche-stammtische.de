...
CITIES = [
    ...
    { 'population':  569000, 'coords': [53.0736,  8.8064], 'state': 'DE-HH (Hamburg)',                'name': 'Bremen' },
    ...
    { 'population':  335000, 'coords': [52.0241,  8.5290], 'state': 'DE-NI (Niedersachsen)',          'name': 'Bielefeld' },
    ...
    { 'population':  249132, 'coords': [54.3233, 10.1228], 'state': 'DE-HH (Hamburg)',                'name': 'Kiel' },
    { 'population':  240114, 'coords': [52.1205, 11.6276], 'state': 'DE-SN (Sachsen)',                'name': 'Magdeburg' },
    { 'population':  236236, 'coords': [47.9990,  7.8421], 'state': 'DE-BW (Baden-Württemberg)',      'name': 'Freiburg' },
    { 'population':  227000, 'coords': [51.4833, 11.9667], 'state': 'DE-NI (Niedersachsen)',          'name': 'Halle (Saale)' },
    { 'population':  227000, 'coords': [51.3392,  6.5862], 'state': 'DE-NW (Nordrhein-Westfalen)',    'name': 'Krefeld' },
    { 'population':  219549, 'coords': [50.9848, 11.0299], 'state': 'DE-SN (Sachsen)',                'name': 'Erfurt' },
    { 'population':  217272, 'coords': [49.9929,  8.2473], 'state': 'DE-BY (Bayern)',                 'name': 'Mainz' },
    { 'population':  217061, 'coords': [53.8655, 10.6866], 'state': 'DE-HH (Hamburg)',                'name': 'Lübeck' },
    ...
    { 'population':  201048, 'coords': [51.3127,  9.4797], 'state': 'DE-NI (Niedersachsen)',          'name': 'Kassel' },
    { 'population':  182971, 'coords': [49.2327,  6.9962], 'state': 'DE-BW (Baden-Württemberg)',      'name': 'Saarbrücken' },
    { 'population':  176110, 'coords': [49.4718,  8.4512], 'state': 'DE-BW (Baden-Württemberg)',      'name': 'Ludwigshafen' },
    { 'population':  155756, 'coords': [49.4103,  8.6971], 'state': 'DE-BW (Baden-Württemberg)',      'name': 'Heidelberg' },
    { 'population':  151389, 'coords': [49.0134, 12.1016], 'state': 'DE-SN (Sachsen)',                'name': 'Regensburg' },
